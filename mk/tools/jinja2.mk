jinja2: deps-python
	...
	@if test -f "$(BIN_DIR)/jinja2"; then (echo "Found jinja2 already in your kit."); else (pip3 install jinja2-cli --install-option="--install-scripts=$(BIN_DIR)") && (echo "Installed jinja2 in your kit."); fi
	@which jinja2
