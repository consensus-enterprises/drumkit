...
init-project-packer-vars-new:
	@echo "Please provide the following information to initialize your Packer scripts:"
	CONTAINER_PROJECT_NAME ?= $(call prompt,$(CONTAINER_PROJECT_NAME_PROMPT), "project-name")
	CONTAINER_REGISTRY_URL ?= $(call prompt,$(CONTAINER_REGISTRY_URL_PROMPT), "registry.gitlab.com")
